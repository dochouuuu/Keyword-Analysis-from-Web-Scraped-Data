...
class extractor:
    ...
    def get_keywords_raw(self):
        completion = self.client.chat.completions.create(
            ...
            messages=[
                {"role": "system", "content": "You are a news article summarizer. You always provide well-reasoned answers that are both correct and helpful. Your answer must follow this syntax: keyword_1, keyword_2, keyword_3, keyword_4, ... ."},
